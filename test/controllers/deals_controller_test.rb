...
class DealsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deal" do
    assert_difference('Deal.count') do
      post deals_url, params: { deal: { description: @deal.description, end_time: @deal.end_time, start_time: @deal.start_time, title: @deal.title, user_id: @deal.user_id } }
    end
  ...
  test "should update deal" do
    patch deal_url(@deal), params: { deal: { description: @deal.description, end_time: @deal.end_time, start_time: @deal.start_time, title: @deal.title, user_id: @deal.user_id } }
